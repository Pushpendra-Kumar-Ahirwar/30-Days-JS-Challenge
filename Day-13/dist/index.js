...
var _modules1Js = require("./modules1.js");
var _modulesJsDefault = parcelHelpers.interopDefault(_modulesJs);
console.log(`<-------------- Task 1--------------->`);
console.log((0, _modulesJs.addition)(10, 20));
console.log(`<-------------- Task 2--------------->`);
console.log((0, _modulesJs.person).name);
console.log(`<-------------- Task 3--------------->`);
console.log((0, _modulesJs.subtract)(10, 20));
console.log((0, _modulesJs.multiply)(10, 20));
console.log(`<-------------- Task 4--------------->`);
console.log((0, _modulesJsDefault.default)("Pushpendra"));
console.log(`<-------------- Task 5--------------->`);
console.log((0, _modules1Js.helloaniket)("Aniket"));
console.log((0, _modules1Js.hellonaman)("Naman"));
console.log((0, _modules1Js.firstfrend));
console.log((0, _modules1Js.secondfrend));
console.log(`<-------------- Task 6--------------->`);
console.log((0, _modulesJs.task6)());
console.log(`<-------------- Task 7--------------->`);
(0, _modulesJs.getData)().then((data)=>console.log(data));

},{"./modules.js":"jp6yo","./modules1.js":"PboVj","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jp6yo":[function(require,module,exports) {
//Activity 1
//Task 1
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
parcelHelpers.export(exports, "task6", ()=>task6);
//Activity 4
//Task 6
...
function task6() {
    ...
    const reversefname = (0, _lodashDefault.default).reverse([
        ...friendsname
    ]);
...
async function getData() {
    try {
        const response = await (0, _axiosDefault.default).get("https://jsonplaceholder.typicode.com/todos/1");
...
},{"lodash":"3qBDj","axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3qBDj":[function(require,module,exports) {
var global = arguments[3];
(function() {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"PboVj":[function(require,module,exports) {
//Activity 3
//Task 5
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "firstfrend", ()=>firstfrend);
parcelHelpers.export(exports, "secondfrend", ()=>secondfrend);
parcelHelpers.export(exports, "helloaniket", ()=>helloaniket);
parcelHelpers.export(exports, "hellonaman", ()=>hellonaman);
function helloaniket(name) {
    return `How are are ${name} `;
}
function hellonaman(name) {
    return `How are are ${name} `;
}
const firstfrend = "Aniket";
const secondfrend = "Lokendra";

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["km5uZ","bB7Pu"], "bB7Pu", "parcelRequiref381")
